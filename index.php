    ...
    <section class="container">
      <div class="testimonial mySwiper">
        <div class="testi-content swiper-wrapper">
          ...
          <div class="slide swiper-slide">
            <img src="images/Alan.jpg" alt="" class="image" />
            <p class="fs-4">
          ...
          <div class="slide swiper-slide">
            <img src="images/pedro.jpg" alt="" class="image" />
            <p class="fs-4">
          ...
          <div class="slide swiper-slide">
            <img src="images/aaron.jpg" alt="" class="image" />
            <p class="fs-4">
              He tenido la oportunidad de comprtir son gente de InovaTech de todo el mundo y he senstido la misma empatia, carisma y actitud de servicios a los demas. Eso es lo que te hace amar a InovaTech su calidez humana.
            </p>
          ...
          <div class="slide swiper-slide">
            <img src="images/isidro.jpg" alt="" class="image" />
            <p class="fs-4">
              He tenido la oportunidad de comprtir son gente de InovaTech de todo el mundo y he senstido la misma empatia, carisma y actitud de servicios a los demas. Eso es lo que te hace amar a InovaTech su calidez humana.
            </p>
          ...
          <div class="slide swiper-slide">
            <img src="images/xitlali.jpg" alt="" class="image" />
            <p class="fs-4">
              He tenido la oportunidad de comprtir son gente de InovaTech de todo el mundo y he senstido la misma empatia, carisma y actitud de servicios a los demas. Eso es lo que te hace amar a InovaTech su calidez humana.
            </p>
